(function (factory) {
  ...
  class Insertable {
    constructor(parent) {
      _defineProperty$1(this, "parent", void 0);

      _defineProperty$1(this, "_groups", encase(Object.create(null)));
  ...
  _defineProperty$1(Insertable, "version", '0.1.0-alpha.0');
  ...
  const Com2 = create$1((p, {}) => createElement("div", null, "\u7EC4\u4EF62"));
  const Com3 = create$1((p, {}) => createElement("div", null, "\u7EC4\u4EF63"));
  mName('Com1', Com1);
  mName('Com2', Com2);
